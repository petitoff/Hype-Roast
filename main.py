...
runBigDifferencesInPrice = BigDifferencesInPrices()

thread5 = Thread(
    target=runBigDifferencesInPrice.main_alert_price_all_crypto)  # get alert price of all crypto if price if fast
# change
